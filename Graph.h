...
public:
    ...
    /* compute and print the weight and number of
    shortest paths from provided source vertex to all other vertices of the graph. You
    may assume that the graph is guaranteed to have non-negative weight edges, and
    that source is a vertex of the graph. The method should work for any source
    vertex. */
    void modifiedDijkstra(int source); //dijkstra for shortest tree path w/repetition, takes source
